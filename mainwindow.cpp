...
void MainWindow::changeresultstyle()
{
    ...
    ui->resultscreen->setGeometry(xx,75,248,45);
    ui->inputscreen->setFont(ifont);
    ui->inputscreen->setGeometry(xx,115,250,30);
}
void MainWindow::changeinputstyle()
{
    ...
    ui->inputscreen->setFont(ifont);
    ui->inputscreen->setGeometry(xx,105,250,40);
    ui->resultscreen->setFont(rfont);
    ui->resultscreen->setGeometry(xx,70,248,40);
}
